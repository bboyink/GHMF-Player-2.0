...
impl DmxMapPanel {
    pub fn new() -> Self {
        let mut fixtures = vec![
            ...
            FixtureDefinition { id: 23, name: "Mod. 4 Back Center".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 24, name: "Mod. 4 Back Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            
            FixtureDefinition { id: 25, name: "Mod. 5 Front Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 26, name: "Mod. 5 Front Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 27, name: "Mod. 5 Center".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 28, name: "Mod. 5 Back Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 29, name: "Mod. 5 Back Center".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 30, name: "Mod. 5 Back Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            
            FixtureDefinition { id: 31, name: "Mod. 6 Front Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 32, name: "Mod. 6 Front Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 33, name: "Mod. 6 Center".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 34, name: "Mod. 6 Back Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 35, name: "Mod. 6 Back Center".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 36, name: "Mod. 6 Back Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            
            FixtureDefinition { id: 37, name: "Mod. 7 Front Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 38, name: "Mod. 7 Front Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 39, name: "Mod. 7 Center".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 40, name: "Mod. 7 Back Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 41, name: "Mod. 7 Back Center".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 42, name: "Mod. 7 Back Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            
            FixtureDefinition { id: 43, name: "Peacock Light 1".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 44, name: "Peacock Light 2".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 45, name: "Peacock Light 3".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 46, name: "Peacock Light 4".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 47, name: "Peacock Light 5".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 48, name: "Peacock Light 6".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 49, name: "Peacock Back Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 50, name: "Peacock Back Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            
            FixtureDefinition { id: 51, name: "Helix Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 52, name: "Helix Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            
            FixtureDefinition { id: 53, name: "Dove Left".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
            FixtureDefinition { id: 54, name: "Dove Right".to_string(), fixture_type: FixtureType::Light, light_type: Some(LightType::RGBW), channel_count: 4, ignore_reset: false },
        ];
